...
--
-- Host: localhost
-- Generation Time: May 23, 2019 at 06:40 PM
...
(1, 'Holynation', NULL, 'Development', 'holynationdevelopment@gmail.com', '', NULL, NULL, 1, 1, NULL);
...
(1, 'Nursery Beginners', 'This is the enrty mode for Nursery class student', 1),
(2, 'Primary Beginners', 'This is the enrty mode for Primary class student', 4);
...
INSERT INTO `school` (`ID`, `school_name`, `school_logo`, `slogan`, `location`, `description`, `school_website`, `school_mail`, `telephone1`, `telephone2`) VALUES
(1, 'Swot Charter College', 'uploads/school/1_5ce6c13c0672e_2019-05-23.png', 'The only school in the city', 'No. 1 Benin City road, Adjacent Kaduna Road, Adewale, Ilorin, Kware State', 'This is a native style in new brand from a good texture', 'swotcharterschool.com', 'swotcharter@gmail.com', '09032410000', '07060720000');
...
INSERT INTO `student_biodata` (`ID`, `surname`, `firstname`, `middlename`, `dob`, `email`, `phone_number`, `gender`, `address`, `state_of_origin`, `lga_of_origin`, `registration_number`, `school_class_id`, `entry_mode_id`, `academic_session_id`, `img_path`, `nationality`, `status`, `religion`) VALUES
(1, 'Holynation', 'Holynation', 'Holynation', '2000-01-06', 'holynationdevelopement@gmail.com', '08109994485', 'Male', 'Ibadan', 'Oyo', 'Egbeda', '200054FJ', 4, 2, 71, NULL, 'Nigerian', 1, 'Christianity');
...
--
-- Dumping data for table `student_session_history`
--

INSERT INTO `student_session_history` (`ID`, `school_class_id`, `academic_session_id`, `student_biodata_id`, `data_submitted`) VALUES
(1, 4, 71, 1, '2019-05-20 15:25:58');
...
INSERT INTO `student_subject_registration` (`ID`, `student_biodata_id`, `school_class_id`, `subject_id`, `session_term_id`, `date_registered`, `academic_session_id`, `term_id`) VALUES
(1, 1, 4, 13, 3, '2019-05-20 15:25:58', 71, 3),
(6, 1, 4, 5, 3, '2019-05-21 16:55:37', 71, 3);
...
INSERT INTO `subject_score` (`ID`, `ca_score1`, `ca_score2`, `ca_total`, `exam_score`, `score`, `student_subject_registration_id`) VALUES
(1, 21, 20, 41, 50, 91, 1),
(5, 10, 10, 20, 30, 50, 6);
...
INSERT INTO `upload_history` (`ID`, `user_id`, `academic_session_id`, `session_term_id`, `school_class_id`, `subject_id`, `document_path`, `user_type`, `date`) VALUES
(1, 1, 71, 3, 4, 13, 'uploads/result/uploaded/2018_2019_Third_Computer Studies_19-05-20 05-25-58.csv', 'admin', '2019-05-20 15:25:59'),
(2, 1, 71, 3, 4, 5, NULL, 'admin', '2019-05-21 16:51:33');
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, NULL, '2019-05-17 21:10:55', NULL, '2019-05-17 21:10:55', 1);
...
--
ALTER TABLE `permission`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40756;
