...
static $typeArray = array('academic_session_id' => 'int','term_id' => 'int','school_class_id' => 'int','times_school_open' => 'int','time_present' => 'int','teacher_comment' => 'text','head_teacher_comment' => 'text','next_term_begins' => 'int');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','academic_session_id' => '','term_id' => '','school_class_id' => '','times_school_open' => '','time_present' => '','teacher_comment' => '','head_teacher_comment' => '','next_term_begins' => '');
...
public function getConfig($session,$class,$term)
{
	$query="select * from configure_report where academic_session_id=? and school_class_id=? and term_id=?";
	$result = $this->db->query($query,array($session,$class,$term));
	$result = $result->result_array();
	if (empty($result)) {
		return false;
	}
